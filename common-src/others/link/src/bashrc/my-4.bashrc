...
set_prompt_command() {
	...
	user_host="${PROMPT_COLOR_MAIN}───┬──(${PROMPT_COLOR_RESET} ${PROMPT_COLOR_USER}${USER}${PROMPT_COLOR_RESET} | ${PROMPT_COLOR_HOST}$(hostname)${PROMPT_COLOR_RESET} ${PROMPT_COLOR_MAIN})${PROMPT_COLOR_RESET}"
	current_dir="${PROMPT_COLOR_MAIN}──┬──(${PROMPT_COLOR_RESET} ${PROMPT_COLOR_DIR}\w${PROMPT_COLOR_RESET} ${PROMPT_COLOR_MAIN})${PROMPT_COLOR_RESET}"
	PS1="\n${user_host}\n   ${PROMPT_COLOR_MAIN}│${PROMPT_COLOR_RESET}\n   ${PROMPT_COLOR_MAIN}└${PROMPT_COLOR_RESET}${current_dir}\n      ${PROMPT_COLOR_MAIN}│${PROMPT_COLOR_RESET}\n      ${PROMPT_COLOR_MAIN}└─────⮞${PROMPT_COLOR_RESET} "
}
PROMPT_COMMAND=set_prompt_command

export MYBASHRC="checked"
export MY_UPDATE_REMOTE_URL="https://raw.githubusercontent.com/kamiya3141/mirror-share-server/refs/heads/main/common-src/others/link/src"