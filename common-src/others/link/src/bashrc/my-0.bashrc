...
set_prompt_command() {
	...
	user_host0="( ${USER} | $(hostname) )-|"
	user_host="${PROMPT_COLOR_MAIN}(${PROMPT_COLOR_RESET} ${PROMPT_COLOR_USER}${USER}${PROMPT_COLOR_RESET} | ${PROMPT_COLOR_HOST}$(hostname)${PROMPT_COLOR_RESET} ${PROMPT_COLOR_MAIN})─┬─(${PROMPT_COLOR_RESET} ${PROMPT_COLOR_DIR}\w${PROMPT_COLOR_RESET} ${PROMPT_COLOR_MAIN})${PROMPT_COLOR_RESET}"
