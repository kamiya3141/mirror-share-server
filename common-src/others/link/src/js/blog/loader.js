...
].map(scriptSettingObject => (scriptSettingObject["defer"] = "", scriptSettingObject["src"] = joinBaseHostname(scriptSettingObject["src"]), scriptSettingObject)).forEach(scriptSettingObject => {
