if (!window.TSObjectExist) console.error("Object.js v1.2.x と Button.js v1.0.0 をDial.jsの前に読み込んでください。");
...
class TSODial extends TSOButton {
	...
	after_init2() {
		...
		this.mouseMoveHandler = (self, e) => {
			if (this.#sensitivenessButtonUsing || !this.#dialValueButtonUsing) return;
