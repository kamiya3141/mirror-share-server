...
class TSObject extends HTMLElement {
	...
	#myAttributes = [["st", "rect", arg => this.shapeType = arg], ["sv", "0,0,100%,100%", arg => this.shapeValue = arg], ["fill", "var(--tso-bc-cl)", arg => this.fill = arg], ["stroke", "var(--tso-bd-cl)", arg => this.stroke = arg + TSObject.addRenewOptionString], ["stroke-weight", "var(--tso-bd-wei)", arg => this.strokeWeight = arg + TSObject.addRenewOptionString], ["stroke-type", "var(--tso-bd-tp)", arg => this.strokeType = arg + TSObject.addRenewOptionString], ["position-type", "lt", arg => this.positionType = arg], ["allow-hover", "false", arg => this.allowHover = arg], ["tv", "", arg => this.text = arg], ["tt", "b", arg => this.textType = arg], ["tpv", "50%,50%,50%,50%", arg => this.textPositionValue = arg], ["tpt", "cxcy", arg => this.textPositionType = arg], ["tc", "var(--tso-black)", arg => this.textColor = arg], ["ts", "1rem", arg => this.textSize = arg], ["allow-hover", "false", arg => this.allowHover = arg]];
	local_chached = false;
