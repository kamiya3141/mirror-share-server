...
class TSObject extends HTMLElement {
	...
	#myAttributes = [["st", "rect", arg => this.shapeType = arg], ["sv", "0,0,100%,100%", arg => this.shapeValue = arg], ["fill", "var(--bc-cl)", arg => this.fill = arg], ["stroke", "var(--bd-cl)", arg => this.stroke = arg], ["stroke-weight", "var(--ln-wei)", arg => this.strokeWeight = arg], ["position-type", "lt", arg => this.positionType = arg], ["allow-hover", this.#allowHoverValue, arg => this.allowHover = arg], ["tv", "", arg => this.text = arg], ["tt", "b", arg => this.text = arg], ["tpv", "50%,50%,50%,50%", arg => this.text = arg], ["tpt", "cxcy", arg => this.text = arg]];
	constructor() {
		super();
